...
class Securimage {
	...
	*/
	...
	function parameters()
	{
	  ...
	  $settings = mysql_query("select * from settings where title='captcha'", $link);
      ...
      $this->perturbation = $settings['perturbation'];
	  $this->image_bg_color = new Securimage_Color('#'.$settings['image_bg_color']);
	  $this->text_color = new Securimage_Color('#'.$settings['text_color']);
	  $this->text_transparency_percentage = $settings['text_transparency_percentage'];
	  $this->num_lines = $settings['num_lines'];
	  $this->line_color = new Securimage_Color('#'.$settings['line_color']);	
	  mysql_close($link);
	}
