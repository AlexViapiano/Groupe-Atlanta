...
{
   $link = query_first("select parent_id, id, seo_url_".$lang." from page_links where id = ".$id);
   if ($link['parent_id'] > 0)
...
{
  global $Process;
  echo_array($Process->email_msg[$msg]);
...
{
    global $Process, $show, $extra, $phrase, $page, $cart;
//echo_array($Process->error_msg);
