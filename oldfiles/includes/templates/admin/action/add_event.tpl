<strong>Add A New Event</strong><br /><hr /><br />
 <form action="{$scriptpath}" method="post" >
		<input type="hidden" value="new_event" name="do" />
...
<div id="tabs-cms">
   ...
   <div id='tabs-cms-{$smarty.foreach.langs.index+1}'>
     <table>
       <tr><td width="70"><strong>Title</strong></td><td><input type="text" name="{$title}" value="{$smarty.post.$title}" size="120" /></td></tr>       
       <tr><td><strong>Description</strong></td><td>{include file="admin/page_content.tpl" content = $smarty.post.$desc page_size = 200 id = $desc}</td></tr>
