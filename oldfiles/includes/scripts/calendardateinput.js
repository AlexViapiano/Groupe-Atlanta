...
var MonthNames = new Array('January','Feruary','March','April','May','June','July','August','September','October','November','December');

// Write out the stylesheet definition for the calendar
with (document) {
   writeln('<style>');
   writeln('td.calendarDateInput {font-family: Tahoma;font-size: 10px;line-height: 10px;color:#333;}');
   writeln('select.calendarDateInput {font-family: Tahoma;font-size: 10px;line-height: 10px;color:#333;}');
   writeln('input.calendarDateInput {font-family: Tahoma;font-size: 10px;line-height: 10px;color:#333;}');
   writeln('</style>');
}
