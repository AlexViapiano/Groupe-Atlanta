...
module.exports = {
  ...
  email: 'Doit &ecirc;tre une adresse &eacute;lectronique valide',
  ...
  phone: 'Doit &ecirc;tre un num&eacute;ro de t&eacute;l&eacute;phone valide',
  zip: 'Must be a valid zip code',
  url: 'Must be a valid URL',
  number: 'Must be a number',
  range: 'Must be a number between {0} and {1}',
  min: 'Doit &ecirc;tre au moins {0} caract&egrave;res',
  max: 'Doit &ecirc;tre sous {0} caract&egrave;res',
  minoption: 'Select at least {0} options',
  maxoption: 'Select no more than {0} options',
  minmax: 'Doit &ecirc;tre comprise entre {0} et {1} caract&egrave;res',
