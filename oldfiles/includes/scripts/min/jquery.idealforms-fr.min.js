...
$.fn.idealRadioCheck = function() {
  ...
  return this.each(function() {
    ...
    $this.parent('label').addClass('ideal-radiocheck-label')
      ...
      $this.css({ left: '-9999px' }) // hide by shifting left
...
$.idealforms.errors = {
  ...
  digits: 'Doit être que des chiffres.',
  name: 'Doit être d\'au moins 3 caractères et ne doit contenir que des lettres.',
  ...
  email: 'Doit être une adresse électronique valide <em>(exemple user@gmail.com)</em>',
  phone: 'Doit être un numéro de téléphone valide. <em>(exemple 555-123-4567)</em>',
  zip: 'Doit être un code postal valide. <em>(exemple H1H 2H2 or H1H2H2)</em>',
  ...
  date: 'Doit être une date valide. <em>(exemple {0})</em>',
  dob: 'Doit être une date de naissance valide.',
